...
public class RippleEffect : MonoBehaviour
{
    ...
    public Shader RippleShader, AddShader;
    private Material RippleMat, AddMat;
    public float rippleFrequency = 0.2f; // Ripple oluşum sıklığı
    public float rippleStrength = 0.2f;  // Ripple gücü
    ...
    void Start()
    {
        ...
        StartCoroutine(Ripples());
        InvokeRepeating("AddRandomRipple", 0, rippleFrequency); // Ripple oluşturmayı başlat
    }
